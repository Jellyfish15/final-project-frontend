...
const { auth, authOrServiceToken } = require("../middleware/auth");
...
router.post("/refresh", authOrServiceToken, async (req, res) => {
  try {
...
// @access  Private (admin only)
router.delete("/old", authOrServiceToken, async (req, res) => {
  try {
